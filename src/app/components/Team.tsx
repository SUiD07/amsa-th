...
const TeamsFlex: React.FC = () => {
  ...
  const title = TitleFlexList[lang as keyof typeof TitleFlexList];
  const mainTeams = teams.filter((t) => t.category === "main");
  const subTeams = teams.filter((t) => t.category === "sub");
                  ...
                  <div className="relative z-10">
                            ...
                            <div className="flex-grow">
                              <div className="flex items-center justify-between mb-2">
                                <h4 className="font-bold text-lg leading-tight group-hover:text-rose-200 transition-colors">
                                 {lang === 'en' ? actitem.name_en : actitem.name_th}
                                </h4>
                              </div>
                              <p className="text-sm text-rose-50/70 leading-relaxed">
                               {lang === 'en' ? actitem.desc_en : actitem.desc_th}
                              </p>
                            </div>
                          </div>
                        </motion.a>
                    ...
                    <div className="pt-12 border-t border-white/10">
                      <div className="flex items-center gap-4 mb-8 justify-start">
                        ...
                        <span className= "text-rose-200/60 text-sm italic font-serif" >
                          {title.minidesc1}
                        </span>
                        {/* <div className="h-px flex-grow bg-white/10" /> */}
                      </div>
                          ...
                          >
                            <div className="flex items-center gap-4 mb-3">
                              ...
                              <h5 className="font-bold text-sm group-hover:text-rose-200 transition-colors">
                               {lang === 'en' ? miniitem.name_en : miniitem.name_th}
                              </h5>
                            </div>
                            <p className="text-xs text-rose-100/50 leading-relaxed">
                            {lang === 'en' ? miniitem.desc_en : miniitem.desc_th}
                            </p>
                          </motion.a>
                        ))}
                      </div>
